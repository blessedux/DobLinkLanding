...
export default function EmbeddableDemo() {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      <div className="swap-container rounded-2xl bg-white/70 border border-[#E3EAFD] shadow-lg p-8" style={{boxShadow: '0 4px 24px 0 rgba(80, 112, 255, 0.08)'}}>
        {/* Connect Wallet Button */}
        <div className="flex items-center justify-between mb-8">
          <h3 className="text-gray-700 font-medium">Invest in DePIN</h3>
          {connected ? (
          ...
          <div className="flex flex-col gap-8">
            <div className="bg-white rounded-xl border border-[#E3EAFD] p-6 flex flex-col gap-4 h-full justify-between">
              ...
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-gray-700 font-medium">{selectedToken.name}</span>
              ...
              <div>
                <div className="flex items-center gap-2">
                  <span className="text-3xl font-bold text-gray-800">{selectedToken.apy}%</span>
                ...
                <div className="text-lg font-medium text-gray-700 mt-2">
                  ${(parseFloat(amount) * (selectedToken.apy / 100)).toFixed(2)} / yr
                </div>
